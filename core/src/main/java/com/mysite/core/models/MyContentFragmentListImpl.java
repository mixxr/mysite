...
@Model(
        ...
        resourceType = MyContentFragmentListImpl.RESOURCE_TYPE
)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class MyContentFragmentListImpl implements ContentFragmentList {

    private static final Logger LOG = LoggerFactory.getLogger(MyContentFragmentListImpl.class);

    public static final String RESOURCE_TYPE = "mysite/components/contentfragmentlist";
    ...
    private void initModel() {
        ...
        // query string 
        String orderByQP = slingHttpServletRequest.getParameter("orderBy");
        LOG.debug("MyCFL orderby={}", orderByQP);
        // end change
        ...
        LOG.debug("MyCFL Query statement: '{}'", searchResult.getQueryStatement());
        ...
        try {
            ...
            while (resourceIterator.hasNext()) {
                ...
                DAMContentFragment contentFragmentModel = new MyDAMContentFragmentImpl(
