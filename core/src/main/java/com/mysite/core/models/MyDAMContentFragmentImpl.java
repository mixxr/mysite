...
public class MyDAMContentFragmentImpl implements DAMContentFragment {

    private static final Logger LOG = LoggerFactory.getLogger(MyDAMContentFragmentImpl.class);
     ...
     */
    public MyDAMContentFragmentImpl(@NotNull Resource contentFragmentResource,
        ...
        if (contentFragment == null) {
            ...
            while (contentElementIterator.hasNext()) {
                ...
                this.exportedElements.put(contentElement.getName(),
                        new MyDAMContentElementImpl(contentTypeConverter, contentElement, variation));
            }
     ...
     */
    public static class MyDAMContentElementImpl implements DAMContentElement {

        private static final Logger LOG = LoggerFactory.getLogger(MyDAMContentElementImpl.class);
         ...
         */
        public MyDAMContentElementImpl(@NotNull ContentTypeConverter converter,
